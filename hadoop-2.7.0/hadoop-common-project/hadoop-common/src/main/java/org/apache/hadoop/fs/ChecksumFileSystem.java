...
public abstract class ChecksumFileSystem extends FilterFileSystem {
  ...
  private static class ChecksumFSInputChecker extends FSInputChecker {
    ...
    public ChecksumFSInputChecker(ChecksumFileSystem fs, Path file, int bufferSize)
      throws IOException {
      super( file, fs.getFileStatus(file).getTotalReplication() );
  ...
  private static class ChecksumFSOutputSummer extends FSOutputSummer {
    ...
    public ChecksumFSOutputSummer(ChecksumFileSystem fs, 
      ...
      this.datas = fs.getRawFileSystem().create(file, permission, overwrite,
                                         bufferSize, replicationVector, blockSize,
                                         progress);
  ...
  private FSDataOutputStream create(Path f, FsPermission permission,
      ...
      long replicationVector, long blockSize,
      Progressable progress) throws IOException {
    ...
    if (writeChecksum) {
      out = new FSDataOutputStream(
          new ChecksumFSOutputSummer(this, f, overwrite, bufferSize, replicationVector,
              blockSize, progress, permission), null);
    } else {
      out = fs.create(f, permission, overwrite, bufferSize, replicationVector,
          blockSize, progress);
  ...
  public FSDataOutputStream createNonRecursive(Path f, FsPermission permission,
      boolean overwrite, int bufferSize, long replicationVector, long blockSize,
      Progressable progress) throws IOException {
    return create(f, permission, overwrite, false, bufferSize, replicationVector,
        blockSize, progress);
  }
