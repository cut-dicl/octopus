...
public class FileStatus implements Writable, Comparable {
  ...
  public FileStatus(long length, boolean isdir, long replicationVector,
                    long blocksize, long modification_time, Path path) {

    this(length, isdir, replicationVector, blocksize, modification_time,
  ...
  public FileStatus(long length, boolean isdir,
    ...
    this.path = path;
    if (replicationVector > 0)
       this.path.setReplication(replicationVector);
  ...
  public FileStatus(FileStatus other) throws IOException {
    ...
    this(other.getLen(), other.isDirectory(), other.getReplicationVector(),
  ...
  /**
   * Get the replication vector of a file
   * @return
   */
  ...
  public void write(DataOutput out) throws IOException {
    ...
    out.writeLong(getReplicationVector());
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    this.replicationVector = in.readLong();
    if (replicationVector > 0)
       this.path.setReplication(replicationVector);
  ...
  public String toString() {
    ...
    if(!isDirectory()){
      ...
      sb.append("; replication=" + ReplicationVector.StringifyReplVector(replicationVector));
