...
public abstract class FileSystem extends Configured implements Closeable {
   ...
   */
  public FSDataOutputStream create(Path f, long replicationVector)
      throws IOException {
    return create(f, true, 
                  getConf().getInt("io.file.buffer.size", 4096),
                  replicationVector,
   ...
   *   the file will be overwritten, and if false an error will be thrown.
   * @param bufferSize the size of the buffer to be used.
   * @param replicationVector required block replication for the file. 
   */
  public FSDataOutputStream create(Path f, 
                                   boolean overwrite,
                                   int bufferSize,
    ...
    return create(f, overwrite, bufferSize, replicationVector, blockSize, null);
  }
   ...
   *   the file will be overwritten, and if false an error will be thrown.
   * @param bufferSize the size of the buffer to be used.
   * @param replication required replication vector for the file.
   * @param blockSize
   * @param progress
   * @throws IOException
  ...
  public FSDataOutputStream create(Path f,
      ...
      long blockSize,
      Progressable progress) throws IOException {
    return create(f, permission, flags, bufferSize, replicationVector,
  ...
  public FSDataOutputStream create(Path f,
    ...
    return create(f, permission, flags.contains(CreateFlag.OVERWRITE), 
        bufferSize, replicationVector, blockSize, progress);
  }
  ...
  protected FSDataOutputStream primitiveCreate(Path f,
    ...
    return this.create(f, absolutePermission,
        flag.contains(CreateFlag.OVERWRITE), bufferSize, replicationVector,
        blockSize, progress);
  }
  ...
  public FSDataOutputStream createNonRecursive(Path f,
      boolean overwrite,
      int bufferSize, long replicationVector, long blockSize,
      Progressable progress) throws IOException {
    return this.createNonRecursive(f, FsPermission.getFileDefault(),
        overwrite, bufferSize, replicationVector, blockSize, progress);
  }
   ...
   */
    ...
    */
    @Deprecated
    public FSDataOutputStream createNonRecursive(Path f, FsPermission permission,
        EnumSet<CreateFlag> flags, int bufferSize, long replicationVector, long blockSize,
        Progressable progress) throws IOException {
 ...
 /**
   ...
   */ 
  @Deprecated
  public short getTotalReplication(Path src) throws IOException {
    return getFileStatus(src).getTotalReplication();
  }

  public long getReplicationVector(Path src) throws IOException {
    return getFileStatus(src).getReplicationVector();
  }
   ...
   */
  public boolean setReplication(Path src, long replicationVector)
    throws IOException {
    return true;
  }
  ...
  public boolean setReplication(Path src, short replication)
    throws IOException {
    return setReplication(src, (long) replication);
  }
  ...
  */
   ...
   */
  @Deprecated
  public long getDefaultReplication() { return 1; }

  /**
   * Get the default replication for a path.   The given path will be used to
   * locate the actual filesystem.  The full path does not have to exist.
   * If the path contains a non-zero replication, then it will be returned.
   * @param path of the file
   * @return default replication for the path's filesystem 
   */
  public long getDefaultReplication(Path path) {
     if (path.getReplication() > 0)
        return path.getReplication();
