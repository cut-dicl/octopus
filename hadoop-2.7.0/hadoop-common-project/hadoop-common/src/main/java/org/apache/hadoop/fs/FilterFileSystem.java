...
public class FilterFileSystem extends FileSystem {
  ...
  public FSDataOutputStream create(Path f,
    ...
    return fs.create(f, permission,
      flags, bufferSize, replicationVector, blockSize, progress, checksumOpt);
  }
  ...
  public FSDataOutputStream createNonRecursive(Path f, FsPermission permission,
    ...
    return fs.createNonRecursive(f, permission, flags, bufferSize, replicationVector, blockSize,
        progress);
  }
   ...
   */
  @Override
  public boolean setReplication(Path src, long replication) throws IOException {
  ...
  @Override
  public long getDefaultReplication(Path f) {
  ...
  protected FSDataOutputStream primitiveCreate(Path f,
    ...
    return fs.primitiveCreate(f, absolutePermission, flag,
        bufferSize, replicationVector, blockSize, progress, checksumOpt);
  }
