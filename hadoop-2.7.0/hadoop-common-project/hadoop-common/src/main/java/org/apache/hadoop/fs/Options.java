...
public final class Options {
  ...
  public static class CreateOpts {
    ...
    public static ReplicationVector repFac(long rv) { 
      return new ReplicationVector(rv);
    }
    ...
    public static class ReplicationVector extends CreateOpts {
      private final long replVector;
      protected ReplicationVector(long replVector) { 
        if (replVector < 0) {
          throw new IllegalArgumentException(
      ...
      public long getValue() { return replVector; }
    }
