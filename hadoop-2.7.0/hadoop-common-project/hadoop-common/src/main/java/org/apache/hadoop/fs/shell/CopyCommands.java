...
class CopyCommands {  
  ...
  static class Cp extends CommandWithDestination {
    ...
    public static final String USAGE = "[-f] [-p | -p[topax]] [-r rep] <src> ... <dst>";
    public static final String DESCRIPTION =
    ...
    @Override
    protected void processOptions(LinkedList<String> args) throws IOException {
      String replFormat = StringUtils.popOptionWithArgument("-r", args);
      if (replFormat != null) {
        setReplicationVector(ReplicationVector
            .ParseReplicationVector(replFormat));
      }
  ...
  public static class Put extends CommandWithDestination {
    ...
    public static final String USAGE = "[-f] [-p] [-l] [-r rep] <localsrc> ... <dst>";
    public static final String DESCRIPTION =
