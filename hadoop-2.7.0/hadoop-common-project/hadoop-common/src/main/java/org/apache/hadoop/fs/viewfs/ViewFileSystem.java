...
public class ViewFileSystem extends FileSystem {
  ...
  public FSDataOutputStream createNonRecursive(Path f, FsPermission permission,
    ...
    return res.targetFileSystem.createNonRecursive(res.remainingPath, permission,
         flags, bufferSize, replicationVector, blockSize, progress);
  }
  
  @Override
  public FSDataOutputStream create(final Path f, final FsPermission permission,
      final boolean overwrite, final int bufferSize, final long replicationVector,
  ...
  @Override
  public boolean setReplication(final Path f, final long replication)
      throws AccessControlException, FileNotFoundException,
      IOException {
    InodeTree.ResolveResult<FileSystem> res = 
      fsState.resolve(getUriPath(f), true);
  ...
  static class InternalDirOfViewFs extends FileSystem {
    ...
    @Override
    public boolean setReplication(Path f, long replication)
        throws AccessControlException, IOException {
      checkPathIsSlash(f);
