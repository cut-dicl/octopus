...
public class SequenceFile {
  ...
  public static class Writer implements java.io.Closeable, Syncable {
    ...
    static class ReplicationOption extends Options.LongOption
                                   implements Option {
      ReplicationOption(long value) {
        super(value);
      }
    }
    ...
    Writer(Configuration conf, 
      ...
      if (ownStream) {
        ...
        long replicationVector = replicationOption == null ? 
        ...
        out = fs.create(p, true, bufferSize, replicationVector, blockSize, progress);
      } else {
