...
import org.apache.hadoop.hdfs.server.blockmanagement.BlockRetrievalPolicyDefault;
import org.apache.hadoop.hdfs.server.datanode.fsdataset.impl.RamDiskReplicaLruTracker;
import org.apache.hadoop.hdfs.server.namenode.replicationmanagement.ReplicationDowngradePolicyDefault;
import org.apache.hadoop.hdfs.server.namenode.replicationmanagement.ReplicationUpgradePolicyDefault;
...
public class DFSConfigKeys extends CommonConfigurationKeys {
  ...
  public class DFS_TRIGGER_UPGRADE_POLICY_CLASSNAME_DEFAULT {
...
public static final String  DFS_BLOCK_SIZE_KEY = "dfs.blocksize";
  ...
  public static final long    DFS_REPLICATION_DEFAULT = 3;
  ...
  public static final String DFS_DATANODE_CACHE_CAPACITY_PERCENT_ALL_KEY = "dfs.datanode.cache.capacity.percent.all";
  public static final String DFS_DATANODE_CACHE_CAPACITY_PERCENT_PARTIAL_KEY = "dfs.datanode.cache.capacity.percent.";
  public static final float DFS_DATANODE_CACHE_CAPACITY_PERCENT_DEFAULT = 0f;
  public static final float DFS_DATANODE_CACHE_CAPACITY_PERCENT_DEFAULT_MEMORY = 0.5f;
  public static final String DFS_DATANODE_ENABLE_PARTIAL_CACHE_READ_KEY = "dfs.datanode.enable.partial.cache.read";
  public static final boolean DFS_DATANODE_ENABLE_PARTIAL_CACHE_READ_DEFAULT = false;
  ...
  public static final int     DFS_NAMENODE_REPLICATION_MAX_STREAMS_DEFAULT = 4;
  ...
  public static final int     DFS_NAMENODE_REPLICATION_STREAMS_HARD_LIMIT_DEFAULT = 6;
  public static final String  DFS_NAMENODE_REPLICATION_TIERING_REVERSE_ORDER_KEY = "dfs.namenode.replication.tiering.reverse.order";
  public static final boolean DFS_NAMENODE_REPLICATION_TIERING_REVERSE_ORDER_DEFAULT = true;
  ...
  //Added from elena for memory 
  public static final String DFS_DATANODE_MEMORY_CAPACITY_KEY = "dfs.datanode.memory.capacity.mb";
  public static final long DFS_DATANODE_MEMORY_CAPACITY_DEFAULT = 512;
  public static final String DFS_DATANODE_MEMORY_DATAPOOL_KEY = "dfs.datanode.memory.datapool.kb";
  public static final int DFS_DATANODE_MEMORY_DATAPOOL_DEFAULT = 1024;
  public static final String DFS_DATANODE_MEMORY_METAPOOL_KEY = "dfs.datanode.memory.metapool.kb";
  public static final int DFS_DATANODE_MEMORY_METAPOOL_DEFAULT = 32;
  
  public static final String  DFS_DATANODE_IO_TEST_BLOCK_SIZE_KEY = "dfs.datanode.io.test.block.size";
  public static final long    DFS_DATANODE_IO_TEST_BLOCK_SIZE_DEFAULT = 128*1024*1024;
  public static final String  DFS_DATANODE_IO_TEST_BUFFER_SIZE_KEY = "dfs.datanode.io.test.buffer.size";
  public static final long    DFS_DATANODE_IO_TEST_BUFFER_SIZE_DEFAULT = 64*1024;

  public static final String DFS_DATANODE_DU_CAPACITY_PREFIX_KEY = "dfs.datanode.du.capacity.";
  public static final long DFS_DATANODE_DU_CAPACITY_DEFAULT = -1;
  
  public static final String  DFS_DATANODE_VOLUME_WRITE_BANDWIDTHPERSEC_PREFIX_KEY = "dfs.datanode.volume.write.bandwidthPerSec.";
  public static final String  DFS_DATANODE_VOLUME_READ_BANDWIDTHPERSEC_PREFIX_KEY = "dfs.datanode.volume.read.bandwidthPerSec.";
  public static final String  DFS_DATANODE_VOLUME_TRANSF_BANDWIDTHPERSEC_PREFIX_KEY = "dfs.datanode.volume.transfer.bandwidthPerSec.";
  public static final long    DFS_DATANODE_VOLUME_BANDWIDTHPERSEC_DEFAULT = -1;
  ...
  public static final String DFS_BLOCK_RETRIEVAL_POLICY_CLASSNAME_KEY = "dfs.block.retrieval.policy.classname";
  public static final Class<BlockRetrievalPolicyDefault> DFS_BLOCK_RETRIEVAL_POLICY_CLASSNAME_DEFAULT = BlockRetrievalPolicyDefault.class;
  public static final String DFS_BLOCK_RETRIEVAL_POLICY_TIERING_BIASMEM_KEY = "dfs.block.retrieval.policy.tiering.biasmem";
  public static final boolean DFS_BLOCK_RETRIEVAL_POLICY_TIERING_BIASMEM_DEFAULT = true;

  public static final String DFS_DYNAMIC_POLICY_CONSIDER_LOAD_BALANCING_KEY = "dfs.dynamic.policy.consider.loadbalancing";
  public static final String DFS_DYNAMIC_POLICY_CONSIDER_PERFORMANCE_KEY = "dfs.dynamic.policy.consider.performance";
  public static final String DFS_DYNAMIC_POLICY_CONSIDER_DIVERSITY_KEY = "dfs.dynamic.policy.consider.diversity";
  public static final String DFS_DYNAMIC_POLICY_CONSIDER_UTILIZATION_KEY = "dfs.dynamic.policy.consider.utilization";
 
  //added by elena for replication management
  public static final String DFS_REPLICATION_EXCLUDED_PATHS = "dfs.replication.excluded.paths";

  public static final String DFS_REPLICATION_DOWNGRADE_ALL_MEM_FILE_KEY = "dfs.replication.downgrade.all.mem.file";
  public static final boolean DFS_REPLICATION_DOWNGRADE_ALL_MEM_FILE_DEFAULT = false;

  public static final String DFS_REPLICATION_DOWNGRADE_POLICY_CLASSNAME_KEY = "dfs.replication.downgrade.policy.classname";
  public static final Class<ReplicationDowngradePolicyDefault> DFS_REPLICATION_DOWNGRADE_POLICY_CLASSNAME_DEFAULT = ReplicationDowngradePolicyDefault.class;
  public static final String DFS_REPLICATION_DOWNGRADE_POLICY_TRIGGER_THRESHOLD_KEY = "dfs.replication.downgrade.policy.trigger.threshold";
  public static final float DFS_REPLICATION_DOWNGRADE_POLICY_TRIGGER_THRESHOLD_DEFAULT = 80f; // percent
  public static final String DFS_REPLICATION_DOWNGRADE_POLICY_CONTINUE_THRESHOLD_KEY = "dfs.replication.downgrade.policy.continue.threshold";
  public static final float DFS_REPLICATION_DOWNGRADE_POLICY_CONTINUE_THRESHOLD_DEFAULT = 75f; // percent
  public static final String DFS_REPLICATION_DOWNGRADE_POLICY_DYNAMIC_TOP_K_KEY = "dfs.replication.downgrade.policy.dynamic.top.k";
  public static final int DFS_REPLICATION_DOWNGRADE_POLICY_DYNAMIC_TOP_K_DEFAULT = 20;
  public static final String DFS_REPLICATION_DOWNGRADE_POLICY_WINDOW_BASED_AGING_KEY = "dfs.replication.downgrade.policy.window.based.aging";
  public static final int DFS_REPLICATION_DOWNGRADE_POLICY_WINDOW_BASED_AGING_DEFAULT = 9; // in hours
  
  public static final String DFS_REPLICATION_DOWNGRADE_POLICY_XGBOOST_MODEL_FILE_PATH_KEY = "dfs.replication.downgrade.policy.xgboost.model.file.path";
  public static final String DFS_REPLICATION_DOWNGRADE_POLICY_XGBOOST_MODEL_FILE_PATH_DEF = "${hadoop.home.dir}/xgboost-downgrade.model";
  public static final String DFS_REPLICATION_DOWNGRADE_POLICY_XGBOOST_TOP_K_KEY = "dfs.replication.downgrade.policy.xgboost.top.k";
  public static final int DFS_REPLICATION_DOWNGRADE_POLICY_XGBOOST_TOP_K_DEF = 20;
  public static final String DFS_REPLICATION_DOWNGRADE_POLICY_XGBOOST_DISCR_THRESHOLD_KEY = "dfs.replication.downgrade.policy.xgboost.discrimination.threshold";
  public static final float DFS_REPLICATION_DOWNGRADE_POLICY_XGBOOST_DISCR_THRESHOLD_DEF = 0.35f;
  
  public static final String DFS_REPLICATION_DOWNGRADE_POLICY_ORACLE_COLD_FILES_KEY = "dfs.replication.downgrade.policy.oracle.cold.files";
  
  public static final String DFS_REPLICATION_UPGRADE_POLICY_CLASSNAME_KEY = "dfs.replication.upgrade.policy.classname";
  public static final Class<ReplicationUpgradePolicyDefault> DFS_REPLICATION_UPGRADE_POLICY_CLASSNAME_DEFAULT = ReplicationUpgradePolicyDefault.class;
  public static final String DFS_REPLICATION_UPGRADE_POLICY_ACCESS_COUNT_KEY = "dfs.replication.upgrade.policy.access.count";
  public static final int DFS_REPLICATION_UPGRADE_POLICY_ACCESS_COUNT_DEFAULT = 3;
  public static final String DFS_REPLICATION_UPGRADE_POLICY_ACCESS_TIME_KEY = "dfs.replication.upgrade.policy.access.time";
  public static final int DFS_REPLICATION_UPGRADE_POLICY_ACCESS_TIME_DEFAULT = 24; // in hours
  public static final String DFS_REPLICATION_UPGRADE_POLICY_WEIGHT_THRESHOLD_KEY = "dfs.replication.upgrade.policy.weight.threshold";
  public static final float DFS_REPLICATION_UPGRADE_POLICY_WEIGHT_THRESHOLD_DEFAULT = 3;
  public static final String DFS_REPLICATION_UPGRADE_POLICY_RFM_TOP_PERCENT_KEY = "dfs.replication.upgrade.policy.rfm.top.percent";
  public static final float DFS_REPLICATION_UPGRADE_POLICY_RFM_TOP_PERCENT_DEFAULT = 5f; // percent
  
  public static final String DFS_REPLICATION_UPGRADE_POLICY_XGBOOST_MODEL_FILE_PATH_KEY = "dfs.replication.upgrade.policy.xgboost.model.file.path";
  public static final String DFS_REPLICATION_UPGRADE_POLICY_XGBOOST_MODEL_FILE_PATH_DEF = "${hadoop.home.dir}/xgboost-upgrade.model";
  public static final String DFS_REPLICATION_UPGRADE_POLICY_XGBOOST_TOP_K_KEY = "dfs.replication.upgrade.policy.xgboost.top.k";
  public static final int DFS_REPLICATION_UPGRADE_POLICY_XGBOOST_TOP_K_DEF = 20;
  public static final String DFS_REPLICATION_UPGRADE_POLICY_XGBOOST_DISCR_THRESHOLD_KEY = "dfs.replication.upgrade.policy.xgboost.discrimination.threshold";
  public static final float DFS_REPLICATION_UPGRADE_POLICY_XGBOOST_DISCR_THRESHOLD_DEF = 0.35f;
  public static final String DFS_REPLICATION_POLICY_WEIGHTED_BIAS_HOURS_KEY = "dfs.replication.policy.weighted.bias.hours";
  public static final int DFS_REPLICATION_POLICY_WEIGHTED_BIAS_HOURS_DEFAULT = 24; // in hours

  public static final String DFS_REPLICATION_UPGRADE_POLICY_ORACLE_HOT_FILES_KEY = "dfs.replication.upgrade.policy.oracle.hot.files";
  
  public static final String DFS_REPLICATION_XGBOOST_MAX_FILE_SIZE_KEY = "dfs.replication.xgboost.max.file.size";
  public static final long DFS_REPLICATION_XGBOOST_MAX_FILE_SIZE_DEF = 20l * 1024l * 1024 * 1024;
  public static final String DFS_REPLICATION_XGBOOST_MAX_CREATION_INTERVAL_SECS_KEY = "dfs.replication.xgboost.max.creation.interval.secs";
  public static final long DFS_REPLICATION_XGBOOST_MAX_CREATION_INTERVAL_SECS_DEF = 48l * 60 * 60;
  public static final String DFS_REPLICATION_XGBOOST_MAX_ACCESS_INTERVAL_SECS_KEY = "dfs.replication.xgboost.max.access.interval.secs";
  public static final long DFS_REPLICATION_XGBOOST_MAX_ACCESS_INTERVAL_SECS_DEF = 48l * 60 * 60;
  public static final String DFS_REPLICATION_XGBOOST_MAX_NUM_ACCESSES_KEY = "dfs.replication.xgboost.max.num.accesses";
  public static final int DFS_REPLICATION_XGBOOST_MAX_NUM_ACCESSES_DEF = 24;
  public static final String DFS_REPLICATION_XGBOOST_RELATIVE_DELTA_KEY = "dfs.replication.xgboost.relative.delta";
  public static final boolean DFS_REPLICATION_XGBOOST_RELATIVE_DELTA_DEF = true;

  //////////////////////////////////////////////
  
  public static final String DFS_NETWORK_SPEED_RACK_MBPS_KEY = "dfs.network.speed.rack.mbps";
  public static final String DFS_NETWORK_SPEED_CLUSTER_MBPS_KEY = "dfs.network.speed.cluster.mbps";
  public static final long   DFS_NETWORK_SPEED_MBPS_DEFAULT = 1024L;
  ...
  //Added by Elena
  public static final String  DFS_DEFAULT_STORAGE_TIER_POLICY_KEY = "dfs.default.storage.tier.policy";
  public static final String DFS_DEFAULT_STORAGE_TIER_POLICY_DEFAULT = "HOT";
