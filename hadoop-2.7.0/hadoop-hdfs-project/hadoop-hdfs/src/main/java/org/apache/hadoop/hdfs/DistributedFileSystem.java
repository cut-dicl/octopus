...
public class DistributedFileSystem extends FileSystem {
  ...
  public FSDataOutputStream create(Path f, FsPermission permission,
      boolean overwrite, int bufferSize, long replicationVector, long blockSize,
      Progressable progress) throws IOException {
    return this.create(f, permission,
        overwrite ? EnumSet.of(CreateFlag.CREATE, CreateFlag.OVERWRITE)
            : EnumSet.of(CreateFlag.CREATE), bufferSize, replicationVector,
  ...
  public HdfsDataOutputStream create(final Path f,
      ...
      final int bufferSize, final long replicationVector, final long blockSize,
    ...
    return new FileSystemLinkResolver<HdfsDataOutputStream>() {
      ...
      public HdfsDataOutputStream doCall(final Path p)
        ...
        final DFSOutputStream out = dfs.create(getPathName(f), permission,
            ...
            true, replicationVector, blockSize, progress, bufferSize, null,
            favoredNodes);
      ...
      public HdfsDataOutputStream next(final FileSystem fs, final Path p)
        ...
        if (fs instanceof DistributedFileSystem) {
          ...
          return myDfs.create(p, permission, overwrite, bufferSize, 
              replicationVector, blockSize, progress, favoredNodes);
        }
  ...
  public FSDataOutputStream create(final Path f, final FsPermission permission,
    ...
    final long replicationVector, final long blockSize, final Progressable progress,
    ...
    return new FileSystemLinkResolver<FSDataOutputStream>() {
      ...
      public FSDataOutputStream doCall(final Path p)
        ...
        final DFSOutputStream dfsos = dfs.create(getPathName(p), permission,
                cflags, replicationVector, blockSize, progress, bufferSize,
                checksumOpt);
      ...
      public FSDataOutputStream next(final FileSystem fs, final Path p)
        ...
        return fs.create(p, permission, cflags, bufferSize,
            replicationVector, blockSize, progress, checksumOpt);
      }
    }.resolve(this, absF);
  }
  ...
  protected HdfsDataOutputStream primitiveCreate(Path f,
    ...
    long replicationVector, long blockSize, Progressable progress,
    ChecksumOpt checksumOpt) throws IOException {
    statistics.incrementWriteOps(1);
    final DFSOutputStream dfsos = dfs.primitiveCreate(
      getPathName(fixRelativePart(f)),
      absolutePermission, flag, true, replicationVector, blockSize,
  ...
  public FSDataOutputStream createNonRecursive(final Path f,
    ...
    return new FileSystemLinkResolver<FSDataOutputStream>() {
      ...
      public FSDataOutputStream doCall(final Path p) throws IOException,
        ...
        final DFSOutputStream dfsos = dfs.create(getPathName(p), permission,
          flag, false, replicationVector, blockSize, progress, bufferSize, null);
        return dfs.createWrappedOutputStream(dfsos, statistics);
      }
      ...
      public FSDataOutputStream next(final FileSystem fs, final Path p)
        ...
        return fs.createNonRecursive(p, permission, flag, bufferSize,
            replicationVector, blockSize, progress);
      }
    }.resolve(this, absF);
  }
  ...
  public void setDefaultStoragePolicy(final String policyName) throws IOException {
      statistics.incrementWriteOps(1);
      dfs.setDefaultStoragePolicy(policyName);  
  }

  /** Get the default storage policy **/
  public BlockStoragePolicy getDefaultStoragePolicy() throws IOException {
      statistics.incrementReadOps(1);
      return dfs.getDefaultStoragePolicy();
  }
  ...
  public RemoteIterator<CacheDirectiveEntry> listCacheDirectives(
	  ...
	  return listCacheDirectives(filter,EnumSet.noneOf(CacheFlag.class));
  }
  ...
  public RemoteIterator<CachePoolEntry> listCachePools() throws IOException {
    return listCachePools(EnumSet.noneOf(CacheFlag.class));
  }
  ...
  public RemoteIterator<CachePoolEntry> listCachePools(EnumSet<CacheFlag> flags) throws IOException{
	  return dfs.listCachePools(flags);
  }
  public RemoteIterator<CacheDirectiveEntry> listCacheDirectives(CacheDirectiveInfo filter, EnumSet<CacheFlag> flags) throws IOException{
	  if (filter == null) {
	    ...
	    final RemoteIterator<CacheDirectiveEntry> iter =
	        dfs.listCacheDirectives(filter, flags);
