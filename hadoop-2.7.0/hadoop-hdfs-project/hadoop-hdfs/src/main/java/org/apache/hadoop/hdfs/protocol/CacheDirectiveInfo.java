...
public class CacheDirectiveInfo {
  ...
  public static class Builder {
    ...
    public CacheDirectiveInfo build() {
      return new CacheDirectiveInfo(id, path, replVector, pool, expiration);
    }
    ...
    public Builder(CacheDirectiveInfo directive) {
      ...
      this.replVector = directive.getReplVector();
    ...
    /**
     * Sets the replication vector used in this request.
     * 
     * @param replVector The replVector used in this request.
     * @return This builder, for call chaining.
     */
    public Builder setReplVector(Long replVector) {
  ...
  CacheDirectiveInfo(Long id, Path path, Long replVector, String pool,
  ...
  public boolean equals(Object o) {
    ...
    return new EqualsBuilder().append(getId(), other.getId()).
        ...
        append(getReplVector(), other.getReplVector()).
  ...
  public String toString() {
    ...
    if (replVector != null) {
      builder.append(prefix).append("replVector: ").append(replVector);
      prefix = ", ";
    }
    if (pool != null) {
