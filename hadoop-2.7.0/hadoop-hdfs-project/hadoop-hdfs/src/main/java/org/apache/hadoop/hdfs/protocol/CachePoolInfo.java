...
public class CachePoolInfo {
  ...
  @Nullable
  EnumMap<StorageType, Long> limitPerType;   
  ...
  public CachePoolInfo(String poolName) {
    ...
    this.limitPerType = new EnumMap<StorageType, Long>(StorageType.class);
  }
   ...
   *         directives in this pool for a specified tier
   */
  public Long getLimit(StorageType type) {
      if (limitPerType.containsKey(type))
          return limitPerType.get(type);
      else 
          return null; //or error message???
  }
 
  public CachePoolInfo setLimit(Long limit, StorageType type) {
    this.limitPerType.put(type, limit);
    return this;
  }
  ...
  public CachePoolInfo setLimits(EnumMap<StorageType, Long> limitPerType) { 
  ...
  public String toString() {
    return new StringBuilder().append("{").
      ...
      append(", limit:").append(limitPerType). //need changes!!!
  ...
  public boolean equals(Object o) {
    ...
    return new EqualsBuilder().
        ...
        append(limitPerType, other.limitPerType).
  ...
  public static void validate(CachePoolInfo info) throws IOException {
    ...
    EnumMap<StorageType, Long> limitsPerType = info.getLimits();
    for(Long limit : limitsPerType.values()){
        if(limit < 0)
