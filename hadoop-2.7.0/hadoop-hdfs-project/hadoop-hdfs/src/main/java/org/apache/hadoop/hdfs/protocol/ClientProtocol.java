...
public interface ClientProtocol {
  ...
  /**
   * Set the default storage policy for a file/directory
   * @param policyName The name of the default storage policy
   */
  @Idempotent
   ...
   * @param additionalReplVector additional replication vector
  ...
  public BatchedEntries<CacheDirectiveEntry> listCacheDirectives(
      long prevId, CacheDirectiveInfo filter, EnumSet<CacheFlag> flags) throws IOException;
   ...
   */
  @Idempotent
  public BatchedEntries<CachePoolEntry> listCachePools(String prevPool, EnumSet<CacheFlag> flags)
      throws IOException;
