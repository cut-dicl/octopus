...
public class DatanodeInfo extends DatanodeID implements Node {
  ...
  public DatanodeInfo(DatanodeInfo from) {
    ...
    this.cacheAvailable = from.getCacheRemaining();
    this.cacheBpUsed = from.getCacheBpUsed();
  ...
  public DatanodeInfo(DatanodeID nodeID, String location,
      ...
      final long cacheAvailable, final long cacheBpUsed,
    ...
    this(nodeID.getIpAddr(), nodeID.getHostName(), nodeID.getDatanodeUuid(),
        ...
        cacheCapacity, cacheUsed, cacheAvailable, cacheBpUsed, lastUpdate, lastUpdateMonotonic,
 ...
 /**
  ...
  public float getCacheRemainingPercent() {
    return DFSUtil.getPercentRemaining(cacheAvailable, cacheCapacity);
  }
  ...
  /** Sets cache free space. */
  public void setCacheRemaining(long cacheAvailable) {
    this.cacheAvailable = cacheAvailable;
  }

  /** Sets cache block pool used. */
  public void setCacheBpUsed(long cacheBpUsed) {
    this.cacheBpUsed = cacheBpUsed;
  }
  ...
  public String getDatanodeReport() {
    ...
    buffer.append("Cache BpUsed: "+cu+" ("+StringUtils.byteDesc(cbpu)+")"+"\n");
