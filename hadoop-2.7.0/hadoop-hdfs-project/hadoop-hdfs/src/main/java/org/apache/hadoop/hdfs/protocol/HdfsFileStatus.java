...
public class HdfsFileStatus {
  ...
  private final long replicationVector;
   ...
   */
  public HdfsFileStatus(long length, boolean isdir, long replicationVector,
   ...
   */
  public final long getReplicationVector() {
    return replicationVector;
  }

  public final short getTotalReplication() {
  ...
  public final FileStatus makeQualified(URI defaultUri, Path path) {
    return new FileStatus(getLen(), isDir(), getReplicationVector(),
