...
public class HdfsLocatedFileStatus extends HdfsFileStatus {
   ...
   * @param replicationVector the file's replication vector
  ...
  public HdfsLocatedFileStatus(long length, boolean isdir,
      long replicationVector, long blocksize, long modification_time,
      long access_time, FsPermission permission, String owner, String group,
      byte[] symlink, byte[] path, long fileId, LocatedBlocks locations,
      int childrenNum, FileEncryptionInfo feInfo, byte storagePolicy) {
    super(length, isdir, replicationVector, blocksize, modification_time,
  ...
  public final LocatedFileStatus makeQualifiedLocated(URI defaultUri,
      Path path) {
    return new LocatedFileStatus(getLen(), isDir(), getReplicationVector(),
