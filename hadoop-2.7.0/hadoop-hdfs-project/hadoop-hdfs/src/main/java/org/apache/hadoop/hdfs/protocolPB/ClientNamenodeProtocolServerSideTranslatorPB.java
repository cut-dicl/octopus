...
public class ClientNamenodeProtocolServerSideTranslatorPB implements
  ...
  static final SetDefaultStoragePolicyResponseProto VOID_SET_DEFAULT_STORAGE_POLICY_RESPONSE =
          SetDefaultStoragePolicyResponseProto.newBuilder().build();
  ...
  public CreateResponseProto create(RpcController controller,
    ...
    try {
      HdfsFileStatus result = server.create(req.getSrc(),
          ...
          req.getReplicationVector(), req.getBlockSize(),
  ...
  public SetReplicationResponseProto setReplication(RpcController controller,
    ...
    try {
      boolean result = 
          server.setReplication(req.getSrc(), req.getReplicationVector());
  ...
  public ListCacheDirectivesResponseProto listCacheDirectives(
    ...
    try {
      ...
      BatchedEntries<CacheDirectiveEntry> entries =
        server.listCacheDirectives(request.getPrevId(), filter, PBHelper.convertCacheFlags(request.getCacheFlags()));
  ...
  public ListCachePoolsResponseProto listCachePools(RpcController controller,
    ...
    try {
      BatchedEntries<CachePoolEntry> entries =
        server.listCachePools(request.getPrevPoolName(), PBHelper.convertCacheFlags(request.getCacheFlags()));
  ...
  @Override
  public SetDefaultStoragePolicyResponseProto setDefaultStoragePolicy(RpcController controller,
          SetDefaultStoragePolicyRequestProto request) throws ServiceException {
      try {
          server.setDefaultStoragePolicy(request.getPolicyName());
      } catch (IOException e) {
          throw new ServiceException(e);
      }
      return VOID_SET_DEFAULT_STORAGE_POLICY_RESPONSE;
  }

  @Override
  public GetDefaultStoragePolicyResponseProto getDefaultStoragePolicy(RpcController controller,
          GetDefaultStoragePolicyRequestProto request) throws ServiceException {
      try {
          BlockStoragePolicy policy = server.getDefaultStoragePolicy();
          GetDefaultStoragePolicyResponseProto.Builder builder =
                  GetDefaultStoragePolicyResponseProto.newBuilder();
          if (policy!= null) {
