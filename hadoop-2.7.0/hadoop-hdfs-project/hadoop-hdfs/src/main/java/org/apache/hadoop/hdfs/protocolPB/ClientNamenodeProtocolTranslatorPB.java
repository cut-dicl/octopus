...
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.GetDefaultStoragePolicyRequestProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.GetDefaultStoragePolicyResponseProto;
...
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.SetDefaultStoragePolicyRequestProto;
...
public class ClientNamenodeProtocolTranslatorPB implements
  ...
  //Added from Elena
  private final static GetDefaultStoragePolicyRequestProto
  VOID_GET_DEFAULT_STORAGE_POLICY_REQUEST =
      GetDefaultStoragePolicyRequestProto.newBuilder().build();
  ...
  public HdfsFileStatus create(String src, FsPermission masked,
    ...
    CreateRequestProto.Builder builder = CreateRequestProto.newBuilder()
        ...
        .setReplicationVector(replicationVector)
  ...
  public LocatedBlock getAdditionalDatanode(String src, long fileId,
      ...
      long additionalReplVector, String clientName) throws AccessControlException,
      FileNotFoundException, SafeModeException, UnresolvedLinkException,
      IOException {
    GetAdditionalDatanodeRequestProto req = GetAdditionalDatanodeRequestProto
        ...
        .setAdditionalReplVector(additionalReplVector)
        .setClientName(clientName)
        .build();
    try {
      ...
      return new BatchedCacheEntries(
        rpcProxy.listCacheDirectives(null,
          ListCacheDirectivesRequestProto.newBuilder().
            ...
            setCacheFlags(PBHelper.convertCacheFlags(flags)).
            build()));
    } catch (ServiceException e) {
      throw ProtobufHelper.getRemoteException(e);
    }
  ...
  @Override
  public BatchedEntries<CachePoolEntry> listCachePools(String prevKey, EnumSet<CacheFlag> flags)
      throws IOException {
    try {
      return new BatchedCachePoolEntries(
        rpcProxy.listCachePools(null,
          ListCachePoolsRequestProto.newBuilder().
            setPrevPoolName(prevKey).setCacheFlags(PBHelper.convertCacheFlags(flags)).build()));
    } catch (ServiceException e) {
      throw ProtobufHelper.getRemoteException(e);
    }
  }
...
public BlockStoragePolicy getDefaultStoragePolicy() throws IOException {
    try {
        GetDefaultStoragePolicyResponseProto response = rpcProxy.getDefaultStoragePolicy(null,
                VOID_GET_DEFAULT_STORAGE_POLICY_REQUEST);
...
@Override
public void setDefaultStoragePolicy(String policyName) throws IOException {
    SetDefaultStoragePolicyRequestProto req = SetDefaultStoragePolicyRequestProto.newBuilder()
            .setPolicyName(policyName).build();
    try {
        rpcProxy.setDefaultStoragePolicy(null, req);
    } catch (ServiceException e) {
        throw ProtobufHelper.getRemoteException(e);
    }
  }
