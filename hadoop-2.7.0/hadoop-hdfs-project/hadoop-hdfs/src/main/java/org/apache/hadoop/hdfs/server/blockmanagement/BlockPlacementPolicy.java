...
public abstract class BlockPlacementPolicy {
   ...
   * @param replicationVector additional number of replicas wanted.
  ...
  /**
   * Same as {@link #chooseTarget(String, long, Node, Set, long, List, StorageType)}
  ...
  DatanodeStorageInfo[] chooseTarget(String src,
    ...
    int numOfReplicas = ReplicationVector.GetTotalReplication(replicationVector);
