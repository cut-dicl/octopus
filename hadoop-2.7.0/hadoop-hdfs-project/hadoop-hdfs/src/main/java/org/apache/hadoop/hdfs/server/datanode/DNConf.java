...
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_DATANODE_ENABLE_PARTIAL_CACHE_READ_KEY;
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_DATANODE_ENABLE_PARTIAL_CACHE_READ_DEFAULT;
...
public class DNConf {
  ...
  final boolean enablePartialCacheRead;
  ...
  public DNConf(Configuration conf) {
    ...
    this.deleteReportInterval = 10 * heartBeatInterval;
    ...
    this.enablePartialCacheRead = conf.getBoolean(
          DFS_DATANODE_ENABLE_PARTIAL_CACHE_READ_KEY, 
          DFS_DATANODE_ENABLE_PARTIAL_CACHE_READ_DEFAULT);
  }
