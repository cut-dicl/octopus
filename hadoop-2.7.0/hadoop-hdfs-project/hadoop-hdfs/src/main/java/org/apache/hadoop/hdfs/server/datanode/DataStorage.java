...
public class DataStorage extends Storage {
  ...
  public final static String STORAGE_DIR_CACHED = "cached";
  ...
  */
  ...
  private void linkAllBlocks(DataNode datanode, File fromDir, File fromBbwDir,
    ...
    if (DataNodeLayoutVersion.supports(
      ...
      // hardlink cached blocks in tmpDir/cached
      linkBlocks(datanode, new File(fromDir, STORAGE_DIR_CACHED),
          new File(toDir, STORAGE_DIR_CACHED), diskLayoutVersion, hardLink);
