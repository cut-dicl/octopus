...
public interface FsDatasetSpi<V extends FsVolumeSpi> extends FSDatasetMBean {
   ...
   *                     volumes.
   */
  public List<V> removeVolumes(Set<File> volumes, boolean clearFailure);
   ...
   * 
   * @param volumeId optional volume id on which to create the replica
