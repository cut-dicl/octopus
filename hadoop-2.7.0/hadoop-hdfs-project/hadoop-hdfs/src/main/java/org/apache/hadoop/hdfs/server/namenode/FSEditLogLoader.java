  ...
  private long applyEditLogOp(FSEditLogOp op, FSDirectory fsDir,
    ...
    case OP_ADD: {
      ...
      if (oldFile == null) { // this is OP_ADD on a new file (case 1)
        ...
        final long replicationVector = fsNamesys.getBlockManager()
            .adjustReplication(addCloseOp.replicationVector);
    ...
    case OP_SET_REPLICATION: {
      ...
      long replicationVector = fsNamesys.getBlockManager().adjustReplication(
          setReplicationOp.replicationVector);
      FSDirAttrOp.unprotectedSetReplication(fsDir, renameReservedPathsOnUpgrade(
          setReplicationOp.path, logVersion), replicationVector, null);
      break;
    }
