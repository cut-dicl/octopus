...
public abstract class FSEditLogOp {
  ...
  static abstract class AddCloseOp extends FSEditLogOp implements BlockListUpdatingOp {
    ...
    <T extends AddCloseOp> T setReplicationVector(long replicationVector) {
    ...
    public void writeFields(DataOutputStream out) throws IOException {
      ...
      FSImageSerialization.writeLong(replicationVector, out);
    ...
    void readFields(DataInputStream in, int logVersion)
      ...
      if (NameNodeLayoutVersion.supports(
          LayoutVersion.Feature.EDITLOG_OP_OPTIMIZATION, logVersion)) {
        this.replicationVector = FSImageSerialization.readLong(in);
        this.mtime = FSImageSerialization.readLong(in);
      } else {
        this.replicationVector = readLong(in);
    ...
    public String stringifyMembers() {
      ...
      builder.append(ReplicationVector.StringifyReplVector(replicationVector));
    ...
    protected void toXml(ContentHandler contentHandler) throws SAXException {
      ...
      XMLUtils.addSaxString(contentHandler, "REPLICATION",
          Long.valueOf(replicationVector).toString());
    ...
    void fromXml(Stanza st) throws InvalidXmlException {
      ...
      this.replicationVector = Long.valueOf(st.getValue("REPLICATION"));
  ...
  static class SetReplicationOp extends FSEditLogOp {
    ...
    SetReplicationOp setReplication(long replicationVector) {
      this.replicationVector = replicationVector;
      return this;
    }
  ...
  static class AddCacheDirectiveInfoOp extends FSEditLogOp {
    ...
    public AddCacheDirectiveInfoOp setDirective(
      ...
      assert(directive.getReplVector() != null);
    ...
    public String toString() {
      ...
      builder.append("replication=" + directive.getReplVector() + ",");
    ...
    public String toString() {
      ...
      if (directive.getReplVector() != null) {
        builder.append(",").append("replication=").
            append(directive.getReplVector());
      }
  ...
  static class AddCachePoolOp extends FSEditLogOp {
    ...
    public String toString() {
      ...
      builder.append("limits=" + info.getLimits());
      appendRpcIdsToString(builder, rpcClientId, rpcCallId);
      builder.append("]");
      return builder.toString();
    }
  ...
  static class ModifyCachePoolOp extends FSEditLogOp {
    ...
    public String toString() {
      ...
      if (info.getLimits() != null) {
        fields.add("limits=" + info.getLimits());
      }
