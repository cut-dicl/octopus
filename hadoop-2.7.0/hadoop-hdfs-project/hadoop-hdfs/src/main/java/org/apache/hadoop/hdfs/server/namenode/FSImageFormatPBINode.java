...
public final class FSImageFormatPBINode {
  ...
  public final static class Loader {
    ...
    private INodeFile loadINodeFile(INodeSection.INode n) {
      ...
      long replicationVector = f.getReplicationVector();
      ...
      for (int i = 0, e = bp.size(); i < e; ++i) {
        blocks[i] = new BlockInfoContiguous(PBHelper.convert(bp.get(i)), totalReplication);
      }
      ...
      final INodeFile file = new INodeFile(n.getId(),
          ...
          f.getAccessTime(), blocks, replicationVector, f.getPreferredBlockSize(),
  ...
  public final static class Saver {
    ...
    public static INodeSection.INodeFile.Builder buildINodeFile(
      ...
      INodeSection.INodeFile.Builder b = INodeSection.INodeFile.newBuilder()
          ...
          .setReplicationVector(file.getReplicationVector())
