...
public interface INodeFileAttributes extends INodeAttributes {
  ...
  /** @return replication vector encoded as a long */
  ...
  public static class SnapshotCopy extends INodeAttributes.SnapshotCopy
    ...
    public SnapshotCopy(byte[] name, PermissionStatus permissions,
        ...
        long replicationVector, long preferredBlockSize, byte storagePolicyID,
        XAttrFeature xAttrsFeature) {
      super(name, permissions, aclFeature, modificationTime, accessTime,
          xAttrsFeature);
      this.replVector = replicationVector;
    ...
    public SnapshotCopy(INodeFile file) {
      ...
      this.replVector = file.getReplicationVector();
    }
