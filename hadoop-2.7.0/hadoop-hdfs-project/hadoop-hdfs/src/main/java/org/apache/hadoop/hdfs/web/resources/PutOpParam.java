...
public class PutOpParam extends HttpOpParam<PutOpParam.Op> {
  ...
  public static enum Op implements HttpOpParam.Op {
    ...
    SETNEWREPLICATION(false, HttpURLConnection.HTTP_OK), // added by nicolas
    ...
    // added by nicolas
    MAKEPOOL(false, HttpURLConnection.HTTP_OK),    
    DELETEPOOL(false, HttpURLConnection.HTTP_OK),
    MODIFYPOOL(false, HttpURLConnection.HTTP_OK),
    MAKECACHEDIRECTIVE(false, HttpURLConnection.HTTP_OK),
    MODIFYDIRECTIVE(false, HttpURLConnection.HTTP_OK),
    DELETEDIRECTIVE(false, HttpURLConnection.HTTP_OK),
