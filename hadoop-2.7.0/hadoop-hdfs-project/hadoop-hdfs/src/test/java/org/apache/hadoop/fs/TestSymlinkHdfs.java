...
abstract public class TestSymlinkHdfs extends SymlinkBaseTest {
  ...
  public void testSetReplication() throws IOException {
    ...
    assertEquals(0, wrapper.getFileLinkStatus(link).getTotalReplication());
    assertEquals(2, wrapper.getFileStatus(link).getTotalReplication());
    assertEquals(2, wrapper.getFileStatus(file).getTotalReplication());
  }
