...
public class TestDFSShell {
  ...
  public void testSetrep() throws Exception {
    ...
    try {
      ...
      assertThat(fs.getFileStatus(hdfsFile1).getTotalReplication(), is(newRepFactor));
      assertThat(fs.getFileStatus(hdfsFile2).getTotalReplication(), is(oldRepFactor));
      ...
      assertThat(shell.run(argv), is(SUCCESS));
      assertThat(fs.getFileStatus(hdfsFile1).getTotalReplication(), is(newRepFactor));
      assertThat(fs.getFileStatus(hdfsFile2).getTotalReplication(), is(newRepFactor));
