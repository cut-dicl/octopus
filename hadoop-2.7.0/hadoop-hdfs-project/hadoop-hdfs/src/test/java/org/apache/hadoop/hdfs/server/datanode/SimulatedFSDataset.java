...
public class SimulatedFSDataset implements FsDatasetSpi<FsVolumeSpi> {
    ...
    synchronized public ReplicaOutputStreams createStreams(boolean isCreate, 
      ...
      if (finalized) {
        ...
        return new ReplicaOutputStreams(oStream, crcStream, requestedChecksum,
            volume.isTransientStorage(), volume.getStorageType());
      }
    }
  ...
  static class SimulatedStorage {
    ...
    synchronized StorageReport getStorageReport(String bpid, 
      ...
      return new StorageReport(dnStorage,
          ...
          0, 0, 0, 0, volume.getReaderCount(), volume.getWriterCount());
    }
  }
  ...
  static class SimulatedVolume implements FsVolumeSpi {
    ...
    private long readThroughput = 0L;
    ...
    public SimulatedStorage getStorage() {
       return storage;
    }
   ...
   public void setReadThroughput(long readThroughput) {
    ...
    @Override
    public File getCachedDir(String bpid) {
        return null;
    }
  ...
  public Map<DatanodeStorage, List<Long>> getCacheReport(String bpid) {
    return new HashMap<DatanodeStorage, List<Long>>(0);
  }
  ...
  public Replica getReplica(String bpid, long blockId, StorageType skip) {
    return getReplica(bpid, blockId);
  }
  ...
  @Override // FsDatasetSpi
  public synchronized void invalidate(String bpid, Block[] invalidBlks, StorageType[] storageTypes)
      throws IOException {
    boolean error = false;
    if (invalidBlks == null) {
      return;
  ...
  @Override // FSDatasetSpi
  public void uncache(String bpid, long[] uncacheBlks, StorageType type) {
    throw new UnsupportedOperationException(
  ...
  @Override // FsDatasetSpi
  public synchronized ReplicaHandler append(StorageType type, 
  ...
  public synchronized ReplicaHandler createRbw(
    ...
    return createTemporary(null, storageType, b);
  }

  @Override // FsDatasetSpi
  public synchronized ReplicaHandler createTemporary(String volume,
  ...
  public StorageReport[] getStorageReports(String bpid) {
    return new StorageReport[] {storage.getStorageReport(bpid, volume)};
  }
  ...
  @Override
  public synchronized List<FsVolumeSpi> removeVolumes(Set<File> volumes, boolean clearFailure) {
    throw new UnsupportedOperationException();
  }
  ...
  public boolean isDeletingBlock(String bpid, long blockId) {
   ...
   public boolean contains(String bpid, long blockId) {
      final Map<Block, BInfo> map = blockMap.get(bpid);
      return map == null? null: map. get(blockId) != null;
   }
