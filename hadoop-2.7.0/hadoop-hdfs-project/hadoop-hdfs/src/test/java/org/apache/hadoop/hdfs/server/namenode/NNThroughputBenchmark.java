...
public class NNThroughputBenchmark implements Tool {
  ...
  abstract class OperationStatsBase {
    ...
    OperationStatsBase() {
      ...
      replication = config.getLong(DFSConfigKeys.DFS_REPLICATION_KEY, 3);
      numOpsRequired = 10;
      numThreads = 3;
  ...
  private static class TinyDatanode implements Comparable<String> {
    ...
    private static final long DF_WRITE_THRU = 30L * 1024;
    private static final long DF_READ_THRU = 60L * 1024;
    ...
    void sendHeartbeat() throws IOException {
      ...
      StorageReport[] rep = { new StorageReport(storage, false,
          ...
          DF_WRITE_THRU, DF_READ_THRU, 0, 0, 0, 0, 0, 0) };
  ...
  class ReplicationStats extends OperationStatsBase {
    ...
    ReplicationStats(List<String> args) {
      ...
      numOpsRequired = (totalBlocks*(short)replication*nodesToDecommission*2)
