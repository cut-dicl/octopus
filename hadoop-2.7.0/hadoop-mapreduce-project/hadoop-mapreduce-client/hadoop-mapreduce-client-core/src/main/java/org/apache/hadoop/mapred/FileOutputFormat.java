...
public abstract class FileOutputFormat<K, V> implements OutputFormat<K, V> {
  ...
  public static void setOutputPath(JobConf conf, Path outputDir) {
    ...
    conf.setLong(org.apache.hadoop.mapreduce.lib.output.
      FileOutputFormat.OUTREPL, outputDir.getReplication());
  }
  ...
  public static void setWorkOutputPath(JobConf conf, Path outputDir) {
    ...
    conf.setLong(JobContext.TASK_OUTPUT_REPL, outputDir.getReplication());
  }
  ...
  public static Path getOutputPath(JobConf conf) {
    ...
    long replication = conf.getLong(org.apache.hadoop.mapreduce.lib.output.
          FileOutputFormat.OUTREPL, -1);
    return name == null ? null: new Path(name, replication);
  }
  ...
  public static Path getWorkOutputPath(JobConf conf) {
    ...
    long replication = conf.getLong(JobContext.TASK_OUTPUT_REPL, -1);
    return name == null ? null: new Path(name, replication);
  }
