...
public interface MRJobConfig {
  ...
  public static final String TASK_OUTPUT_REPL = "mapreduce.task.output.replication";
  ...
  public static final String MR_AM_MAX_CONTAINERS_TO_ASSIGN =
        MR_AM_PREFIX + "max.containers.to.assign";
  ...
  // MRAppMaster task assignment solver class
  public static final String MR_AM_TASK_ASSIGNMENT_SOLVER_CLASS =
          MR_AM_PREFIX + "task.assignment.solver.class";

  public static final String MR_AM_TASK_ASSIGNMENT_ENABLE_TIERS =
          MR_AM_PREFIX + "task.assignment.solver.enable.tiers";
