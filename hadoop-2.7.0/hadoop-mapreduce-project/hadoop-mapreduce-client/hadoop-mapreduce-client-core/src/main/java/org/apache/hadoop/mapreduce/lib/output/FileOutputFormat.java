...
public static final String OUTREPL = "mapreduce.output.fileoutputformat.outputreplication";
  ...
  public static void setOutputPath(Job job, Path outputDir) {
    ...
    job.getConfiguration().setLong(FileOutputFormat.OUTREPL, outputDir.getReplication());
  }
  ...
  public static Path getOutputPath(JobContext job) {
    ...
    long replication = job.getConfiguration().getLong(FileOutputFormat.OUTREPL, -1);
