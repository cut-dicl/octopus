...
public class TestDistCpUtils {
  ...
  public void testPreserveDefaults() throws IOException {
    ...
    Assert.assertTrue(srcStatus.getTotalReplication() == dstStatus.getTotalReplication());
  }
  ...
  public void testPreserveNothingOnDirectory() throws IOException {
    ...
    Assert.assertTrue(dstStatus.getTotalReplication() == 0);
  }
  ...
  public void testPreserveNothingOnFile() throws IOException {
    ...
    Assert.assertFalse(srcStatus.getTotalReplication() == dstStatus.getTotalReplication());
  }
  ...
  public void testPreserveOnFileUpwardRecursion() throws IOException {
    ...
    Assert.assertTrue(srcStatus.getTotalReplication() == f2Status.getTotalReplication());
    ...
    Assert.assertFalse(srcStatus.getTotalReplication() == f1Status.getTotalReplication());
    ...
    Assert.assertFalse(srcStatus.getTotalReplication() == f0Status.getTotalReplication());
    ...
    Assert.assertFalse(srcStatus.getTotalReplication() == d2Status.getTotalReplication());
    ...
    Assert.assertFalse(srcStatus.getTotalReplication() == d1Status.getTotalReplication());
  }
  ...
  public void testPreserveOnDirectoryUpwardRecursion() throws IOException {
    ...
    Assert.assertTrue(srcStatus.getTotalReplication() != d2Status.getTotalReplication());
    ...
    Assert.assertTrue(srcStatus.getTotalReplication() != d1Status.getTotalReplication());
    ...
    Assert.assertFalse(srcStatus.getTotalReplication() == f2Status.getTotalReplication());
  ...
  public void testPreserveOnFileDownwardRecursion() throws IOException {
    ...
    Assert.assertTrue(srcStatus.getTotalReplication() == f0Status.getTotalReplication());
  ...
  public void testPreserveOnDirectoryDownwardRecursion() throws IOException {
    ...
    Assert.assertTrue(srcStatus.getTotalReplication() != rootStatus.getTotalReplication());
