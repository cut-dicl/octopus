...
public abstract class ResourceRequest implements Comparable<ResourceRequest> {
  ...
  public static ResourceRequest newInstance(Priority priority, String hostName,
      ...
      NavigableMap<Integer, Integer> preferences) {
    return newInstance(priority, hostName, capability, numContainers,
        relaxLocality, null, preferences);
  }
  ...
  public static ResourceRequest newInstance(Priority priority, String hostName,
      Resource capability, int numContainers, boolean relaxLocality,
      String labelExpression, NavigableMap<Integer, Integer> preferences) {
...
////////////////////////////////////////////////////////////////////
/**
* Set preferences of storage types of this resource request. 
* 
* Store for each containerRequest and map storage tier order value to a count
*
* 
* @param preferences of storage types (order values) of the host/rack/*
*/
@Public
@Evolving
public abstract void setPreferences(NavigableMap<Integer, Integer> preferences);

/**
* Get preferences of storage types for this Resource Request. 
*  
* 
* @return Map of preferences of storage types (order values) with their counts
*/
@Public
@Evolving
public abstract NavigableMap<Integer, Integer> getPreferences();

/**
* Get preference of a specific storage type for this Resource Request. 
*  
* 
* @param orderType is the specific storage type order value
* @return count of preference of this storage type (order value)
*/
@Public
@Evolving
public abstract int getPreferenceCount(int orderType);

/**
* Increase count of preference of a specific storage type (order value). 
* 
* @param orderType is the specific storage type order value
*/
@Public
@Evolving
public abstract void incrCountPreference(int orderType);

/**
* Decrease count of preference of a specific storage type (order value). 
* 
* @param orderType is the specific storage type order value
*/
@Public
@Evolving
public abstract void decrCountPreference(int orderType);
