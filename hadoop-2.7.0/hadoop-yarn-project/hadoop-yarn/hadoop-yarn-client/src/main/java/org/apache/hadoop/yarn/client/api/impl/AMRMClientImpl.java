...
public class AMRMClientImpl<T extends ContainerRequest> extends AMRMClient<T> {
      ...
      synchronized (this) {
        ...
        for(ResourceRequest r : ask) {
          ...
          askList.add(ResourceRequest.newInstance(r.getPriority(),
              ...
              r.getRelaxLocality(), r.getNodeLabelExpression(), r.getPreferences()));
        }
  ...
  private void
    ...
    Integer preference = req.getPreference(resourceName);
    if (preference != null)
       resourceRequestInfo.remoteRequest.incrCountPreference(preference);
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug("addResourceRequest:" + " applicationId="
          ...
          + " preferences=" + resourceRequestInfo.remoteRequest.getPreferences()
          + " #asks=" + ask.size());
    }
  }
  ...
  private void decResourceRequest(Priority priority, 
    ...
    Integer preference = req.getPreference(resourceName);
    if (preference != null)
       resourceRequestInfo.remoteRequest.decrCountPreference(preference);
    ...
    if(resourceRequestInfo.remoteRequest.getNumContainers() < 0) {
      ...
      resourceRequestInfo.remoteRequest.setPreferences(null);
    }
    ...
    if (LOG.isDebugEnabled()) {
      LOG.info("AFTER decResourceRequest:" + " applicationId="
          ...
          + " resourceName=" + resourceName + " numContainers="
          + resourceRequestInfo.remoteRequest.getNumContainers() 
          + " preferences=" + Arrays.asList(resourceRequestInfo.remoteRequest.getPreferences())
          + " #asks=" + ask.size());
    }
  }
