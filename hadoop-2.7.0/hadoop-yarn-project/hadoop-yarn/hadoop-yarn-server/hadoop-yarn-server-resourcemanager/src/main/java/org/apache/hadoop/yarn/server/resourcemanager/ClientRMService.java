...
public class ClientRMService extends AbstractService implements
  ...
  public GetClusterMetricsResponse getClusterMetrics(
    ...
    ymetrics.setNumAllocatedMemory(queueMetrics.getAllocatedMB());
    ymetrics.setNumAvailableMemory(queueMetrics.getAvailableMB());
    ymetrics.setNumReservedMemory(queueMetrics.getReservedMB());
    ymetrics.setNumAllocatedCores(queueMetrics.getAllocatedVirtualCores());
    ymetrics.setNumAvailableCores(queueMetrics.getAvailableVirtualCores());
    ymetrics.setNumReservedCores(queueMetrics.getReservedVirtualCores());
    ymetrics.setNumAppsRunning(queueMetrics.getAppsRunning());
    ymetrics.setNumAppsPending(queueMetrics.getAppsPending());
    //---------------------------------------
